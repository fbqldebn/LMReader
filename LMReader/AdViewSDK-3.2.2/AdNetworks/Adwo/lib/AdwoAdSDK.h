...
/** Adwo Ad SDK版本号的数值表示 */
#define ADWO_SDK_VERSION                    0x69

/** Adwo Ad SDK版本号的字符串表示 */
#define ADWO_SDK_VERSION_STRING             @"6.9"

//混淆代码
#if 1

#define AWAdViewDelegate  FUCKU_AssDelegate
#define adwoGetBaseViewController   FUCKU_GetBaseViewController
#define adwoAdViewDidFailToLoadAd   FUCKU_DidFailToLoadAss
#define adwoAdViewDidLoadAd         FUCKU_DidLoadAss
#define adwoFullScreenAdDismissed   FUCKU_ShitDismissed
#define adwoDidPresentModalViewForAd    FUCKU_DidPresentModalViewForAss
#define adwoDidDismissModalViewForAd    FUCKU_DidDismissModalViewForAss
#define adwoUserClosedImplantAd     FUCKU_GodClosedGoldenAss
#define adwoUserClosedBannerAd      FUCKU_GodClosedSilverAss
#define adwoAdRequestShouldPause    FUCKU_AssShouldPause
#define adwoAdRequestMayResume      FUCKU_AssMayResume
#define adwoAdNotifyToFetchBonus FUCKU_NotifyToFetchBonus
#define adwoUserClosedVideoAd FUCKU_UserClosedVideoAd
#define adwoUserPlayVideoAd FUCKU_UserPlayVideoAd

#define AWSocialShareDelegate       FUCKU_Ass_ShareDelegate
#define adwoSocialShareMessage      FUCKU_HeavenShareMessage

#define adwoAdStopBannerAutoRefresh FUCKU_StopBannerAutoRefresh
#define AdwoAdCreateBanner  FUCKU_CreateBanner
#define AdwoAdRemoveAndDestroyBanner    FUCKU_RemoveAndDestroyBanner
#define AdwoAdLoadBannerAd  FUCKU_LoadBannerAss
#define AdwoAdAddBannerToSuperView  FUCKU_AddBannerToSuperView
#define AdwoAdGetBannerRequestInterval  FUCKU_GetBannerRequestInterval
#define AdwoAdGetFullScreenAdHandle FUCKU_GetFullScreenAssHandle
#define AdwoAdLoadFullScreenAd  FUCKU_LoadFullScreenAss
#define AdwoAdShowFullScreenAd  FUCKU_ShowFullScreenAss
#define AdwoAdSetGroundSwitchAdAutoToShow   FUCKU_SetGroundSwitchAssAutoToShow
#define AdwoAdGetFullScreenRequestInterval  FUCKU_GetFullScreenRequestInterval
#define AdwoAdCreateImplantAd   FUCKU_CreateImplantAss
#define AdwoAdRemoveAndDestroyImplantAd FUCKU_RemoveAndDestroyImplantAss
#define AdwoAdLoadImplantAd FUCKU_LoadImplantAss
#define AdwoAdShowImplantAd FUCKU_ShowImplantAss
#define AdwoAdImplantAdActivate FUCKU_mplantAssActivate
#define AdwoAdSetImplantAdInteractiveInfo   FUCKU_SetImplantAssInteractiveInfo
#define AdwoAdGetImplantRequestInterval FUCKU_GetImplantRequestInterval
#define AdwoAdGetLatestErrorCode    FUCKU_GetLatestErrorCode
#define AdwoAdSetAdAttributes   FUCKU_SetAssAttributes
#define AdwoAdSetKeywords   FUCKU_SetKeywords
#define AdwoAdSetDelegate   FUCKU_SetDelegate
#define AdwoAdGetAdInfo FUCKU_GetAssInfo
#define AdwoAdGetCurrentAdID    FUCKU_GetCurrentAssID
#define AdwoAdRegisterSocialShareDelegate   FUCKU_RegisterSocialShareDelegate
#define AdwoAdReceiveSocialShareResult  FUCKU_ReceiveSocialShareResult
#define AdwoAdLaunchETA FUCKU_LaunchETA

#define AdwoUtilities FUCKU_Utilities
...
#define AdwoLaunchingAdInfo FUCKU_LaunchingAssInfo
#define AdwoFSAdShowInfo    FUCKU_FSAssShowInfo
