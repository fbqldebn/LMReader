...
@interface AdViewView : UIView {
	id<AdViewDelegate> __weak delegate;
 ...
 */
@property (nonatomic, weak) IBOutlet id<AdViewDelegate> delegate;
 ...
 * 创建adView视图
 */
+ (AdViewView *)requestAdViewViewWithAppKey:(NSString*)appkey WithDelegate:(id<AdViewDelegate>)delegate;
