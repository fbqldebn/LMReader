...
+ (AdViewController*) sharedControllerByAppKey;             //多个实例之一，存在直接返回，否则新建返回
+ (AdViewController*) sharedControllerIfExistsByAppKey:(NSString*)appKey;     //多个实例之一，检查是否存在，存在则返回，否则返回nil
